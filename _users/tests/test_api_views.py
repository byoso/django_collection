...
class TestApiViews(APITestCase):
    ...
    def test_login(self):
        url = reverse('_users:token_login')
    ...
    def test_logout(self):
        ...
        url = reverse('_users:token_logout')
    ...
    def test_email_confirm_email_resend(self):
        ...
        self.user.save()
        url = reverse('_users:email_confirm_email_resend')
    ...
    def test_password_request_reset(self):
        url = reverse('_users:password_request_reset')
        response = self.client.post(url, {'credential': 'testuserx'})
        self.assertEqual(response.status_code, 400)
        response = self.client.post(url, {'credential': 'testuser'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_password_change(self):
        self.api_authentication()
        url = reverse('_users:password_change')
    ...
    def test_email_request_change(self):
        self.api_authentication()
        url = reverse('_users:email_request_change')
    ...
    def test_users_delete_me(self):
        ...
        self.api_authentication()
        url = reverse('_users:users_delete_me')
